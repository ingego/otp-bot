...
Future <void> envSetUp(String name, String locale)async{url = "https://www.leagueofgraphs.com/summoner/$locale/$name";
...
Future <void> envSetUp(String name, String locale)async{url = "https://ru.op.gg/summoners/$locale/$name";
      resp = await Dio().get(url!);}
